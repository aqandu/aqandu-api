...
"""
http://localhost:5000/api/getEstimateAtLocations?startTime=2021-09-20T00:00:00Z&endTime=2021-09-20T01:00:00Z&lats=40.744170269017914,40.74417&lons=-111.86633278523858,-111.866&timeInterval=60
"""
...
class getEstimateAtLocations(Resource):
    ...
    def get(self, **kwargs):
        ...
        if (query_lats.shape != query_lons.shape):
            return make_response('lat, lon must be equal sized arrays of floats:'+str(query_lats)+' ; ' + str(query_lons), 400)
